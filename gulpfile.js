...
var gulp = require("gulp"),
  ...
  autoprefixer = require("gulp-autoprefixer"), // Corrected this line
...
gulp.task("styles", function (cb) {
  gulp.series(
    "clean-styles",
    gulp.parallel("styles-screen", "styles-critical"),
    "styles-inject",
  )(cb);
});
...
gulp.task("styles-inject", function () {
  return gulp
    .src("./default.hbs")
    .pipe(
      inject(gulp.src("./assets/css/critical.min.css", { read: true }), {
...
gulp.task("clean", function () {
  return del(["./**/.DS_Store", "./dist/"]);
});

gulp.task("clean-styles", function () {
  return del(["./**/.DS_Store", "./assets/css/"]);
});

gulp.task("clean-build", function () {
  return del(["./.DS_Store", "./**/.DS_Store", "build/**"]);
});
...
gulp.task("build", function (cb) {
  gulp.series(
    gulp.parallel("styles", "styles-comb"),
    "clean",
    "build-other",
    "build-theme-move",
    "build-theme-zip",
...
gulp.task("default", function (cb) {
  gulp.series(gulp.parallel("styles", "scripts", "svg"), "watch")(cb);
});
